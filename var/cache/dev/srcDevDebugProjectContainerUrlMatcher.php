...
class srcDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    private function doMatch(string $rawPathinfo, array &$allow = array(), array &$allowSchemes = array()): ?array
    {
        ...
        switch ($pathinfo) {
            case '/customer':
                // show_customer_form
                $ret = array('_route' => 'show_customer_form', '_controller' => 'App\\Controller\\CustomerController::showForm');
                if (!isset(($a = array('GET' => 0))[$canonicalMethod])) {
                    $allow += $a;
                    goto not_show_customer_form;
                }

                return $ret;
                not_show_customer_form:
                // handle_customer_form
                $ret = array('_route' => 'handle_customer_form', '_controller' => 'App\\Controller\\CustomerController::handleForm');
                if (!isset(($a = array('POST' => 0))[$requestMethod])) {
                    $allow += $a;
                    goto not_handle_customer_form;
                }

                return $ret;
                not_handle_customer_form:
                break;
            case '/flicker':
                // show_flicker_form
                $ret = array('_route' => 'show_flicker_form', '_controller' => 'App\\Controller\\FlickerController::showFlicker');
                if (!isset(($a = array('GET' => 0))[$canonicalMethod])) {
                    $allow += $a;
                    goto not_show_flicker_form;
                }

                return $ret;
                not_show_flicker_form:
                // handle_flicker_form
                $ret = array('_route' => 'handle_flicker_form', '_controller' => 'App\\Controller\\FlickerController::handleFlicker');
                if (!isset(($a = array('POST' => 0))[$requestMethod])) {
                    $allow += $a;
                    goto not_handle_flicker_form;
                }

                return $ret;
                not_handle_flicker_form:
                break;
            default:
                $routes = array(
                    ...
                    '/' => array(array('_route' => 'index', '_controller' => 'App\\Controller\\HomeController::hello'), null, null, null),
                    '/lucky/number' => array(array('_route' => 'app_lucky_number', '_controller' => 'App\\Controller\\LuckyController::number'), null, null, null),
                    '/hello' => array(array('_route' => 'hello_world', '_controller' => 'App\\Controller\\HelloController::helloWorld'), null, null, null),
                );
                ...
                switch ($m = (int) $matches['MARK']) {
                    default:
                        $routes = array(
                            ...
                            190 => array(array('_route' => 'hello_prenom', '_controller' => 'App\\Controller\\HelloController::helloPrenom'), array('prenom', 'age'), null, null),
                        );
